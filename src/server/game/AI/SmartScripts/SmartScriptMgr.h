...
enum SMART_ACTION
{
    ...
    SMART_ACTION_SET_DATA                           = 45,     // Field, Data (only works for creatures, gameobject support not implemented)
    ...
    SMART_ACTION_SET_CAN_FLY                        = 119,    // NOT IMPLEMENTED - Reserved for future flying state control
    SMART_ACTION_REMOVE_AURAS_BY_TYPE               = 120,    // NOT IMPLEMENTED - Reserved for removing auras by type mask
    ...
    SMART_ACTION_REMOVE_MOVEMENT                    = 127,    // NOT IMPLEMENTED - Reserved for stopping all movement
    ...
    SMART_ACTION_SPAWN_SPAWNGROUP                   = 131,    // NOT IMPLEMENTED - Reserved for spawning spawn groups
    SMART_ACTION_DESPAWN_SPAWNGROUP                 = 132,    // NOT IMPLEMENTED - Reserved for despawning spawn groups
    SMART_ACTION_RESPAWN_BY_SPAWNID                 = 133,    // NOT IMPLEMENTED - Reserved for respawning by spawn ID
