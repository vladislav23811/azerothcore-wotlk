...
public:
    ...
    {
        // NOTE: Item Upgrade applies percentage multipliers AFTER Reforging flat changes
        // This ensures proper stat calculation order:
        // Base stat -> Reforging (flat decrease/increase) -> Item Upgrade (percentage multiplier)
        // The val parameter already has Reforging modifications applied (if any)
