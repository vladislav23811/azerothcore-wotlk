...
enum ItemUpgradeStringConfigs
{
    ...
    CONFIG_ITEM_UPGRADE_WEAPON_SPEED_PERCENTS,
...
enum ItemUpgradeIntConfigs
{
    ...
    CONFIG_ITEM_UPGRADE_WEAPON_SPEED_TOKEN,
    CONFIG_ITEM_UPGRADE_WEAPON_SPEED_TOKEN_COUNT,
    CONFIG_ITEM_UPGRADE_WEAPON_SPEED_MONEY,
