...
public:
    ...
    void OnPlayerAchievementSave(CharacterDatabaseTransaction /* trans */, Player *player, uint16 achId, CompletedAchievementData const& achiData) override {
    ...
    void OnPlayerCriteriaSave(CharacterDatabaseTransaction /* trans */, Player* player, uint16 critId, CriteriaProgress const& criteriaData) override {
