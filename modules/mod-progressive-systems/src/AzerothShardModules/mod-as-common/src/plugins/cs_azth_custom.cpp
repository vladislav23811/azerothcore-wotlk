...
public:
    azth_commandscript() : CommandScript("azth_commandscript") { }
     ...
     ChatCommandTable GetCommands() const override {
         // name, function, level, console
         static ChatCommandTable lookupAzthCommands =
         {
            //{ "fixranks", handleFixRanks, SEC_PLAYER, Console::No },
            { "arealevel", handlePrintAreaLevel, SEC_PLAYER, Console::No },
            // { "maxskill", handleAzthMaxSkill, SEC_PLAYER, Console::No },
            // { "xp", handleAzthXP, SEC_PLAYER, Console::No },
            //{ "pstatinfo", handleAzthCurrLevel, SEC_PLAYER, Console::No },
            // { "smartstone", handleAzthSmartstone, SEC_PLAYER, Console::No },
            // { "bonus", handleAzthBonus, SEC_ADMINISTRATOR, Console::No },
            // { "ptype", handlePlayerType, SEC_PLAYER, Console::No },
         };

         static ChatCommandTable commandTable =
         {
             { "azth", lookupAzthCommands },
            //  { "qc", HandleQuestCompleterCommand, SEC_PLAYER, Console::No },
         };
         return commandTable;
     }
