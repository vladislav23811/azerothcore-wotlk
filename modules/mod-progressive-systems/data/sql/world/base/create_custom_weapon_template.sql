...
SELECT 
    ...
    src.class, src.subclass, src.SoundOverrideSubclass, src.name,
    src.displayid, src.Quality, src.Flags, src.FlagsExtra, src.BuyCount, src.BuyPrice, src.SellPrice,
    src.InventoryType, src.AllowableClass, src.AllowableRace, src.ItemLevel, src.RequiredLevel,
    src.RequiredSkill, src.RequiredSkillRank, src.RequiredSpell, src.RequiredHonorRank,
    src.RequiredCityRank, src.RequiredReputationFaction, src.RequiredReputationRank,
    src.maxcount, src.stackable, src.ContainerSlots,
    src.stat_type1, src.stat_value1, src.stat_type2, src.stat_value2,
    src.stat_type3, src.stat_value3, src.stat_type4, src.stat_value4,
    src.stat_type5, src.stat_value5, src.stat_type6, src.stat_value6,
    src.stat_type7, src.stat_value7, src.stat_type8, src.stat_value8,
    src.stat_type9, src.stat_value9, src.stat_type10, src.stat_value10,
    src.ScalingStatDistribution, src.ScalingStatValue,
    src.dmg_min1, src.dmg_max1, src.dmg_type1, src.dmg_min2, src.dmg_max2, src.dmg_type2,
    src.armor, src.holy_res, src.fire_res, src.nature_res, src.frost_res, src.shadow_res, src.arcane_res,
    src.delay, src.ammo_type, src.RangedModRange,
    src.spellid_1, src.spelltrigger_1, src.spellcharges_1, src.spellppmRate_1, src.spellcooldown_1,
    src.spellcategory_1, src.spellcategorycooldown_1,
    src.spellid_2, src.spelltrigger_2, src.spellcharges_2, src.spellppmRate_2, src.spellcooldown_2,
    src.spellcategory_2, src.spellcategorycooldown_2,
    src.spellid_3, src.spelltrigger_3, src.spellcharges_3, src.spellppmRate_3, src.spellcooldown_3,
    src.spellcategory_3, src.spellcategorycooldown_3,
    src.spellid_4, src.spelltrigger_4, src.spellcharges_4, src.spellppmRate_4, src.spellcooldown_4,
    src.spellcategory_4, src.spellcategorycooldown_4,
    src.spellid_5, src.spelltrigger_5, src.spellcharges_5, src.spellppmRate_5, src.spellcooldown_5,
    src.spellcategory_5, src.spellcategorycooldown_5,
    src.bonding, src.description, src.PageText, src.LanguageID, src.PageMaterial,
    src.startquest, src.lockid, src.Material, src.sheath, src.RandomProperty, src.RandomSuffix,
    src.block, src.itemset, src.MaxDurability, src.area, src.Map, src.BagFamily, src.TotemCategory,
    src.socketColor_1, src.socketContent_1, src.socketColor_2, src.socketContent_2,
    src.socketColor_3, src.socketContent_3, src.socketBonus, src.GemProperties,
    src.RequiredDisenchantSkill, src.ArmorDamageModifier, src.duration, src.ItemLimitCategory,
    src.HolidayId, src.ScriptName, src.DisenchantID, src.FoodType, src.minMoneyLoot, src.maxMoneyLoot,
    src.flagsCustom
FROM `item_template` AS src
WHERE src.`entry` = 19019  -- Thunderfury (Legendary Sword)
ON DUPLICATE KEY UPDATE `entry` = 99990;  -- Skip if already exists
